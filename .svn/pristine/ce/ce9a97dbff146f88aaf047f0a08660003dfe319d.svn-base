...
// const { navsFirstLevelPath } = storeToRefs(permissionStore)

// // 监听permissionStore.navsFirstLevelPath
// watch(
//   () => navsFirstLevelPath.value,
//   (navsFirstLevelPath: string[]) => {
//     // console.log(navsFirstLevelPath, 'navsFirstLevelPath')
  ...
  setup() {
    ...
    return () => (
      ...
      >
        ...
        <Menu
          v-model={permissionStore.navsFirstLevelPath}
          class={[
