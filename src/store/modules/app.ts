...
export const useAppStore = defineStore('app', {
  state: (): AppState => {
    return {
      ...
      formIsOpen: false, // 是否显示表单弹窗

      settingDrawer: false, // 是否显示系统配置弹窗
  ...
  getters: {
    ...
    getFormIsOpen(): boolean { // formIsOpen
  ...
  actions: {
    ...
    initTheme() {
      ...
      // 判断是否是首次进入系统 (读取主题数据 本地存储 app.theme)
      const appData = JSON.parse(localStorage.getItem('app') || '{}')
      if (!appData.theme) {
        this.setTheme({
          "elColorPrimary": "#009688",
          "topHeaderBgColor": "#5172dc",
          "topHeaderTextColor": "#fff",
          "topHeaderHoverColor": "#6081eb",
          "topToolBorderColor": "#5172dc",
          "leftMenuBorderColor": "inherit",
          "leftMenuBgColor": "#273352",
          "leftMenuBgLightColor": "#364261",
          "leftMenuBgActiveColor": "var(--el-color-primary)",
          "leftMenuCollapseBgActiveColor": "var(--el-color-primary)",
          "leftMenuTextColor": "#bfcbd9",
          "leftMenuTextActiveColor": "#fff",
          "logoTitleTextColor": "#fff",
          "logoBorderColor": "#273352"
        })
      }
    },
